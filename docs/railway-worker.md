...
In dry-run mode the worker fetches and validates pending Mirage commands but does not confirm receipts and does not send Telegram execution notifications.
